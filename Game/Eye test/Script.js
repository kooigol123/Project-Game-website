...
class Game {
  ...
  _gameWin() {
    ...
    const text = new Konva.Text({
      ...
      text: `คุณชนะเกมนี้แล้ว
      
ยินดีด้วย คุณได้ชนะเกมนี้เป็นที่เรียบร้อยแล้ว❤️

(คลิกเพื่อเริ่มเล่นเกมใหม่)
`,
      fontSize: 13,
      opacity: 0,
      width: this.gameWidth,
...
คะแนนของคุณคือ : ${this.difficulty - 1}

คุณทำได้ดีแล้วนะ สู้ต่อไปนะคุณ ❤️
